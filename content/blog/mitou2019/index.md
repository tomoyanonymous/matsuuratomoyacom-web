...
{{<tweet user="tomoya_nonymous" id="1125812480830140416">}}
...
{{<tweet user="tomoya_nonymous" id="1130365905504858112">}}
...
{{<tweet user="tomoya_nonymous" id="1151127436672684032">}}

# 泥沼(インタプリタの限界)

問題はブースト会議直前にたどり着いた音響合成の仮実装のパフォーマンスがあまりに悪かったことでした。どのくらい悪いかというとサイン波を合成するのに70％くらいCPUを食われる有様です。

{{<tweet user="tomoya_nonymous" id="1151838761002520576">}}
...
{{<tweet user="tomoya_nonymous" id="1186312140434497537">}}
...
{{<tweet user="tomoya_nonymous" id="1210816342518988801">}}
...
{{<tweet user="tomoya_nonymous" id="1222172757124763649">}}

@をつけて関数を時間指定して実行

{{<tweet user="tomoya_nonymous" id="1223127556842328064">}}

LibSndFileからオーディオファイル読み込み(含配列アクセスの簡易実装)

{{<tweet user="tomoya_nonymous" id="1224604194612498432">}}

あとロゴを作った

{{<tweet user="tomoya_nonymous" id="1223167879916339200">}}
