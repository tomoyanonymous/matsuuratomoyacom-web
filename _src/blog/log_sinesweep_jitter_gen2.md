...
今回は実際にインパルス応答測定のためのパッチづくりを、実際にJitterとGenで作ったパッチの中身を見ながら解説していこうと思います。
...
この時一番問題になるのは時間領域→周波数領域に変換するFFTで、信号を一定間隔で切り出して順次FFTするような形になっています。感覚のコントロールは可能ですが一回だけFFTして止める、みたいな事をするのは至難の技です。
